...
export const usersRoutes = async (app) => {
    ...
    app.post('/users', async (req, reply) => {
        ...
        const result = db
            .prepare('INSERT INTO users (username, email, password_hash, avatar, is_admin, must_change_password) VALUES (?, ?, ?, ?, ?, ?)')
