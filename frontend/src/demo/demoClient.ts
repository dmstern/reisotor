...
function defaultStore(): Store {
  return {
    ...
    "/ideas/likes": structuredClone(
      DEMO_EXCURSION_LIKES,
    ) as unknown as Collection,
    "/ideas/comments": structuredClone(
      DEMO_EXCURSION_COMMENTS,
    ) as unknown as Collection,
    ...
    "/spots/comments": structuredClone(
      DEMO_SPOT_COMMENTS,
    ) as unknown as Collection,
    ...
    "/budget/allocations": structuredClone(
      DEMO_BUDGET_ALLOCATIONS,
    ) as unknown as Collection,
    "/budget/transfers": structuredClone(
      DEMO_BUDGET_TRANSFERS,
    ) as unknown as Collection,
    ...
    "/notes/comments": structuredClone(
      DEMO_NOTE_COMMENTS,
    ) as unknown as Collection,
    ...
    "/diary/comments": structuredClone(
      DEMO_DIARY_COMMENTS,
    ) as unknown as Collection,
    "/tracks": [],
    "/notifications": [],
...
export async function demoRequest<T>(
  ...
  if (path === "/auth/config")
    return { registrationMode: "off" } as unknown as T;
