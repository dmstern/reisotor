...
export const ACTION_ICONS: Record<ActionIconKey, IconDef> = {
  ...
  today: { id: 'calendar-event', emoji: '📍', outline: IconCalendarEvent, filled: IconCalendarEventFilled },
  ...
  filterSettings: { id: 'adjustments', emoji: '⚙️', outline: IconAdjustments, filled: IconAdjustmentsFilled },
  recordStart: { id: 'player-record', emoji: '⏺️', outline: IconPlayerRecord, filled: IconPlayerRecordFilled },
  ...
  done: { id: 'circle-check', emoji: '✅', outline: IconCircleCheck, filled: IconCircleCheckFilled },
  ...
  orientationHeading: { id: 'binoculars', emoji: '🔭', outline: IconBinoculars, filled: IconBinocularsFilled },
  ...
  myLocation: { id: 'current-location', emoji: '📍', outline: IconCurrentLocation, filled: IconCurrentLocationFilled },
  ...
  save: { id: 'device-floppy', emoji: '💾', outline: IconDeviceFloppy, filled: IconDeviceFloppyFilled },
  offline: { id: 'wifi-off', emoji: '📴', outline: IconWifiOff },
  pause: { id: 'player-pause', emoji: '⏸️', outline: IconPlayerPause, filled: IconPlayerPauseFilled },
  ...
  warning: { id: 'alert-triangle', emoji: '⚠️', outline: IconAlertTriangle, filled: IconAlertTriangleFilled },
  ...
  comment: { id: 'message-circle', emoji: '💬', outline: IconMessageCircle, filled: IconMessageCircleFilled },
  ...
  priorityDot: { id: 'circle-filled', emoji: '🔴', outline: IconCircleFilled, filled: IconCircleFilled },
