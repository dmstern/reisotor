...
// stores/dashboardConfig.ts, ProfileView.vue) - 1:1 dasselbe Testmuster wie navbar-config.spec.ts
...
test('hiding a dashboard tile in ProfileView removes it from the Dashboard', async ({ page }) => {
  await page.goto('/');
